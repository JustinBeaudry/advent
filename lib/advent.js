    ...
    ***************************************************************************** */
    ...
    var AdventLogger = /** @class */ (function () {
        ...
        AdventLogger.prototype.error = function (err, message, additionalMeta, tags) {
            var meta = __assign({}, additionalMeta, { error: {
                    message: err.message,
        ...
        AdventLogger.prototype.log = function (level, message, meta, tags) {
            ...
            var event = AdventEvent.Construct({
                ...
                message: message,
                meta: __assign({}, this.meta, meta),
                tags: new Set(__spread(this.tags, tags))
            });
    ...
    function AdventState(state, previous) {
        if (state === void 0) { state = INITIAL_STATE; }
        var newState;
        if (previous) {
            newState = __assign({}, previous, state);
        }
        else {
    ...
    var AdventEventStore = /** @class */ (function () {
        ...
        AdventEventStore.prototype.addIndexes = function (item) {
            ...
            if (item.event.tags.size > 0) {
                try {
                    for (var _b = __values(item.event.tags), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var tag = _c.value;
    ...
    (function (IntervalStates) {
        IntervalStates[IntervalStates["paused"] = 0] = "paused";
        IntervalStates[IntervalStates["running"] = 1] = "running";
    })(IntervalStates || (IntervalStates = {}));
    var PausableInterval = /** @class */ (function () {
        function PausableInterval(fn, rate) {
            this.state = 0 /* paused */;
        ...
        PausableInterval.Constructor = function (_a) {
            var rate = _a.rate, fn = _a.fn;
            return new PausableInterval(fn, rate);
        };
        PausableInterval.prototype.start = function () {
            if (!this.interval) {
                this.interval = this.createInterval();
            }
        ...
        PausableInterval.prototype.createInterval = function () {
            var _this = this;
            return window.setInterval(function () {
                if (_this.state === 1 /* running */) {
                    _this.fn();
                }
            }, this.rate);
        };
    ...
    var AdventEventSync = /** @class */ (function () {
        ...
        AdventEventSync.prototype.start = function () {
            var e_2, _a;
            try {
                for (var _b = __values(this.destinations), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var dest = _c.value;
                    dest.start();
                }
            }
        ...
        AdventEventSync.prototype.sync = function (transport) {
            ...
            try {
                for (var _b = __values(this.store.getEvents(predicate)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var AdventConsoleTransport = /** @class */ (function () {
    ...
    var Advent = /** @class */ (function () {
        ...
        Advent.prototype.getTags = function () {
            return this.store.getTags();
        };
        Advent.prototype.flushEvents = function () {
            this.store.flush();
        };
